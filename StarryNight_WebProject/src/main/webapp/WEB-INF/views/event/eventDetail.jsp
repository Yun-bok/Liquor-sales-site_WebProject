		...
		<div class="row">
        	...
        	<div class="evForm">	
				...
				<div class="evInput">
				    ...
				    <div class="col-50">
				      <textarea id="event_content" name="event_content" placeholder="내용을 입력하세요." style="height:200px">
				      ${event.event_content}</textarea>
				    </div>
				</div>
				<div class="filebox">
					<div class="col-25">
				  		<label for="ex_filename">파일</label> 
				  	</div>
				  	<div class="col-50">
				...
				<br>
				<span>
			   		<button type="button" id="delBtn" onclick="deleteProc()">삭제</button>		
